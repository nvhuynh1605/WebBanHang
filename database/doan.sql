...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 01, 2023 lúc 01:56 PM
...
(3, 3, 1, 'noname', '6.jpg', 'Đồng hồ Casio GA-110JT-2A', 5, 8000000, 'sao hoa', '2023-06-13', 0),
...
(14, 9, 1, 'lvd', '12.jpg', 'Đồng hồ Casio GM-S5600YS-1', 3, 12150000, 'hcm', '2023-07-01', 0);
...
(3, 4, 'Đồng hồ Casio GA-110JT-2A', 92, '2023-06-01', 2000000, 15, '6.jpg', 20, 'aaa', 1),
...
(5, 4, 'Đồng hồ Casio GLX-S5600-3', 94, '2023-06-01', 10000000, 11, '8.jpg', 20, 'Đồng hồ Casio G Shock GLX-S5600-3DR dành cho nam, nữ với dây đeo bằng nhựa màu xanh kết hợp mặt vuông cùng đồ thị thủy triều, Size mặt 40,5mm nằm trong bộ sưu tập đồng hồ G-Shock G-Lide mới nhất hiện nay.\r\nGLX-S5600, mỏng, nhỏ gọn và có khả năng gắn kết cao, được sử dụng làm mô hình cơ sở. G-LIDE mới có tông màu đậm trên khuôn mặt với màu cơ bản trông giống retro của hương vị lướt sóng của thập niên 90. \r\n', 1),
...
(9, 4, 'Đồng hồ Casio GM-S5600YS-1', 197, '2023-06-02', 5000000, 9, '12.jpg', 19, 'Đồng hồ G-Shock GM-S5600YS-1DR thuộc đồng hồ Casio nữ, dây nhựa + dây đi kèm, mặt vuông điện tử viền kim loại, thiết kế thể thao, chống nước 200m, bảo hành 5 năm nằm trong bộ sưu tập đồng hồ G Shock nữ mới nhất.\r\nĐồng hồ GM-S5600YS-1 là mẫu kết hợp giữa G-SHOCK với sự mệnh không ngừng trong việc đạt được độ bền tối đa và Y’s, thương hiệu đầu tiên được ra mắt bởi nhà thiết kế nổi tiếng thế giới Yohji Yamamoto.\r\n', 1),
...
(15, 4, 'Đồng hồ Casio GA-114RE-1A', 50, '2023-06-01', 10000000, 15, '5.jpg', 0, 'Đồng hồ Casio G-Shock GA-114RE-1ADR thuộc Casio nam, dây nhựa màu đen, kim - số tiêu chuẩn, phiên bản giới hạn, chống nước 200M, chống từ, chống va đập, size mặt 51,2mm nằm trong bộ sưu tập đồng hồ G Shock mới nhất.\r\nDòng sản phẩm giới hạn \"G-SHOCK 40th Anniversary REMASTER BLACK\" của G-SHOCK sẽ kỷ niệm 40 năm thành lập vào năm 2023. Trong hình ảnh các cột mốc và tượng đài bằng đá, tên của các mô hình kế tiếp của 40 năm qua được khắc trên dây đeo, và toàn bộ được hoàn thiện bằng màu đen.\r\n', 1),
(16, 3, 'Đồng hồ Apple Watch SE 2022 GPS 40mm', 143, '2023-06-02', 6300000, 10, '14.png', 5, 'Đồng hồ thông minh Apple Watch SE (2022) 40mm (GPS) là sản phẩm mới ra mắt gần đây sở hữu thiết kế sang trọng đẳng cấp cùng nhiều tính năng hiện đại hứa hẹn đem đến trải nghiệm tuyệt với cho người dùng.', 1),
...
--
ALTER TABLE `comment`
  MODIFY `cmt_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
